...
class Tree {
    ...
    public static int diam(TreeNode root) {
        ...
        int inc = 1 + height(root.left) + height(root.right);
        int exc = Math.max(diam(root.left), diam(root.right));
...
public class Main {
    public static void main(String[] args) {
        ...
        TreeNode root = Tree.buildTree(scanner);

        int diameter = Tree.diam(root);
